...
- Mean: `r round(steps.mean,2)`
- Median: `r round(steps.median,2)`
...
- Average 5-minute interval with max number of steps: `r names(max.int)`
...
- Number of missing values: `r count.na`
...
- Mean (corrected): `r round(steps.mean.c,2)`
- Median (corrected): `r round(steps.median.c,2)`
